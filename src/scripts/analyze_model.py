...
def load_model_and_data(device):
    ...
    # Set up processor — inject dataset to avoid redundant load_dataset call
...
def main():
    ...
    # In test mode, use tiny subsets to verify logic end-to-end
    ...
    # Pre-process shared data for analyses 2 and 3
